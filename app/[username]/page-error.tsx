...
export default function NotFoundPage() {
  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center bg-white p-4 text-center dark:bg-black">
      ...
      <div className="z-10 flex flex-col items-center">
        ...
        <p className="mx-auto mt-4 max-w-sm text-slate-600 dark:text-slate-400">
          Oops! Parece que o perfil que você está procurando não existe, foi
          removido ou está configurado como privado. Que tal voltar para um
          lugar seguro?
        </p>
        ...
        {canGoBack ? (
          ...
          <Button className="mt-8 gap-2 font-semibold" size="lg" asChild>
            <Link href="/dashboard/linktree">Ir para os meus Linktrees</Link>
          </Button>
        )}
      </div>
    </main>
