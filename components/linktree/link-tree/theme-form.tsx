...
//   const { toast } = useToast()
  ...
  const handleDarkModeToggle = () => {
    ...
    // })
    toast.success(`${newTheme.charAt(0).toUpperCase() + newTheme.slice(1)} mode activated. Switched to ${newTheme} mode.`)
  }
  ...
  const handleResetDefaults = () => {
    ...
    // })
    toast.success("Theme reset. Theme settings have been reset to defaults.")
  }
